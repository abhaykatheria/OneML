...
const allLessons: LessonEntry[] = [
  ...
  { id: 'systems/design-redis', file: 'DesignRedis', title: 'Design Redis', description: 'In-memory key-value store: event loop, persistence (RDB/AOF), replication, and cluster hash slots', track: 'systems', order: 13, tags: ['redis', 'system-design', 'in-memory', 'replication', 'persistence'] },
  { id: 'systems/design-rabbitmq', file: 'DesignRabbitMQ', title: 'Design RabbitMQ', description: 'Message broker: exchanges, queues, routing, acknowledgments, and quorum queues', track: 'systems', order: 14, tags: ['rabbitmq', 'system-design', 'message-broker', 'amqp', 'exchanges'] },
  { id: 'systems/design-s3', file: 'DesignS3', title: 'Design S3 (Object Storage)', description: 'Distributed object storage: erasure coding, metadata sharding, and multipart upload', track: 'systems', order: 15, tags: ['s3', 'system-design', 'object-storage', 'erasure-coding'] },
  { id: 'systems/design-task-scheduler', file: 'DesignTaskScheduler', title: 'Design a Task Scheduler', description: 'Distributed task scheduling: timing wheels, exactly-once execution, and worker pools', track: 'systems', order: 16, tags: ['task-scheduler', 'system-design', 'cron', 'exactly-once'] },
  ...
  { id: 'systems/design-betting', file: 'DesignBetting', title: 'Design a Betting Platform', description: 'Real-time sports betting: atomic bet placement, odds engine, settlement pipeline, and cash-out', track: 'systems', order: 21, tags: ['betting', 'system-design', 'real-time', 'odds', 'settlement', 'wallet'] },
  { id: 'systems/design-robinhood', file: 'DesignRobinhood', title: 'Design Robinhood', description: 'Stock trading: order lifecycle, smart order routing (NBBO), real-time portfolio, and risk management', track: 'systems', order: 22, tags: ['robinhood', 'system-design', 'trading', 'order-book', 'portfolio', 'fintech'] },
  { id: 'systems/design-google-docs', file: 'DesignGoogleDocs', title: 'Design Google Docs', description: 'Real-time collaborative editing: OT engine, WebSocket at scale, presence, revision history, and offline sync', track: 'systems', order: 23, tags: ['google-docs', 'system-design', 'collaboration', 'ot', 'websocket', 'real-time'] },
  { id: 'systems/pubsub-models', file: 'PubSubModels', title: 'Pub-Sub Models Deep Dive', description: 'How Redis Pub/Sub, Kafka, RabbitMQ, and managed cloud services implement publish-subscribe — push vs pull, durable vs ephemeral, and when to use which', track: 'systems', order: 24, tags: ['pub-sub', 'messaging', 'redis', 'kafka', 'rabbitmq', 'nats', 'sns'] },
  { id: 'systems/design-flink', file: 'DesignFlink', title: 'Design Apache Flink', description: 'Stream processing at scale: job graph, event time and watermarks, windowing, stateful operators, checkpoint barriers, and exactly-once guarantees', track: 'systems', order: 25, tags: ['flink', 'system-design', 'stream-processing', 'event-time', 'watermarks', 'checkpointing', 'exactly-once'] },
  { id: 'systems/design-messaging', file: 'DesignRealtimeMessaging', title: 'Design a Real-Time Messaging App (100M users)', description: 'WhatsApp / Messenger at scale: WebSocket gateways, per-conversation ordering, hybrid fan-out for groups, presence via Redis Pub/Sub, offline delivery, and E2E encryption', track: 'systems', order: 26, tags: ['messaging', 'whatsapp', 'websocket', 'real-time', 'fan-out', 'presence', 'e2e-encryption', 'system-design'] },
  { id: 'systems/design-notification-service', file: 'DesignNotificationService', title: 'Design a Notification Service', description: 'Multi-channel notifications at 100M-user scale: per-channel workers, circuit breakers, retries with exponential backoff, rate-shaped broadcasts, preferences, and compliance', track: 'systems', order: 27, tags: ['notification-service', 'push', 'email', 'sms', 'webhook', 'rate-limiting', 'compliance', 'system-design'] },
  { id: 'systems/databases-deep-dive', file: 'DatabasesDeepDive', title: 'Databases Deep Dive', description: 'Comparative deep dive into Postgres, MySQL, MongoDB, Redis, Cassandra, ScyllaDB, DynamoDB, RocksDB, ClickHouse, Elasticsearch, CockroachDB — storage engines, row vs columnar, consistent hashing, and when to pick which', track: 'systems', order: 28, tags: ['databases', 'postgres', 'mysql', 'mongodb', 'redis', 'cassandra', 'scylla', 'dynamodb', 'rocksdb', 'clickhouse', 'elasticsearch', 'cockroachdb', 'system-design'] },
  ...
  { id: 'datastructures/count-min-sketch', file: 'CountMinSketch', title: 'Count-Min Sketch: Frequency Estimation', description: 'Estimate item frequencies in massive streams with bounded overcount', track: 'datastructures', order: 7, tags: ['count-min-sketch', 'frequency', 'streaming', 'top-k'] },
  { id: 'datastructures/cuckoo-filter', file: 'CuckooFilter', title: 'Cuckoo Filters: Better Bloom Filters', description: 'Probabilistic membership with deletion support and better space efficiency', track: 'datastructures', order: 8, tags: ['cuckoo-filter', 'bloom-filter', 'deletion', 'fingerprint'] },
  { id: 'datastructures/skip-list', file: 'SkipList', title: 'Skip Lists: Probabilistic Sorted Structure', description: 'O(log n) sorted operations without rotations — the engine behind Redis sorted sets', track: 'datastructures', order: 9, tags: ['skip-list', 'redis', 'sorted-set', 'probabilistic'] },
  { id: 'datastructures/merkle-tree', file: 'MerkleTree', title: 'Merkle Trees: Tamper-Proof Verification', description: 'Detect data differences in O(log n) — used in Git, Cassandra, and blockchain', track: 'datastructures', order: 10, tags: ['merkle-tree', 'hash-tree', 'anti-entropy', 'git', 'blockchain'] },
  { id: 'datastructures/ring-buffer', file: 'RingBuffer', title: 'Ring Buffers: Fixed-Size FIFO', description: 'Zero-allocation circular queues for kernel I/O, logging, and inter-thread messaging', track: 'datastructures', order: 11, tags: ['ring-buffer', 'circular-buffer', 'fifo', 'producer-consumer'] },
  { id: 'datastructures/reservoir-sampling', file: 'ReservoirSampling', title: 'Reservoir Sampling: Random Samples from Streams', description: 'Uniform random sampling from unknown-length streams in O(K) memory', track: 'datastructures', order: 12, tags: ['reservoir-sampling', 'streaming', 'random-sample', 'algorithm-r'] },
  { id: 'datastructures/trie', file: 'Trie', title: 'Tries & Radix Trees: Prefix Matching', description: 'Autocomplete, IP routing, and spell checking with prefix trees', track: 'datastructures', order: 13, tags: ['trie', 'radix-tree', 'prefix', 'autocomplete', 'ip-routing'] },
